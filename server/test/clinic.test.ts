...
before(async()=>{
 ...
 else {const pg=new PGlite();for(const file of ['001_initial.sql','003_room_retirement.sql','004_staff_workflow.sql'])await pg.exec(readFileSync(new URL('../sql/'+file,import.meta.url),'utf8'));
